...
Students are required to purchase two texts for this class. They're better in actual print than as ebooks. We will be using them every week. All additional reqdings are availabel either through the university library (linked on the calendar page), or on Canvas under the files section. I would encourage you to print out those readings and mark them up by hand as well. The research is quite convincing that this is better for your brain. Regardless, students are **required to read** the assignents before each class meeting. 
